...
export class ProductsController {
  ...
  @Get('particular')
  getParticularProduct(@Query('type') type?: string, @Query('name') name?: string, @Query('id') productId?: number, @Query('user') userId?: number) {
  ...
  @UseGuards(JwtGuard)
  @Delete()
  deleteProductByName(@Query('user', ParseIntPipe) userId: number, @Query('product', ParseIntPipe) productId) {
